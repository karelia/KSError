 ...
 */
+ (NSError *)errorWithDomain:(NSString *)domain code:(NSInteger)code localizedDescription:(NSString *)description recoverySuggestion:(nullable NSString *)recoverySuggestion;
